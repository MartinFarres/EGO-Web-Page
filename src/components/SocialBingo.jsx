...
const allTasks = [
  ...
  { id: 19, emoji: '🍻', text: 'Haz un brindis grupal' },
  { id: 20, emoji: '🎭', text: 'Imita a alguien famoso' },
  { id: 21, emoji: '🔥', text: 'Cuenta tu anécdota más vergonzosa' },
  { id: 22, emoji: '👯', text: 'Encuentra a tu gemelo del bar' },
  { id: 23, emoji: '🎲', text: 'Juega piedra, papel o tijera con 3 personas' },
  { id: 24, emoji: '💬', text: 'Inicia una conversación profunda' },
  { id: 25, emoji: '🌮', text: 'Recomienda tu lugar favorito para comer' },
  { id: 26, emoji: '🎸', text: 'Habla de tu banda/artista favorito' },
  { id: 27, emoji: '🏆', text: 'Comparte algo de lo que estés orgulloso' },
  { id: 28, emoji: '🌈', text: 'Di algo positivo sobre 3 personas' },
  { id: 29, emoji: '🎪', text: 'Haz algo que te dé vergüenza' },
  { id: 30, emoji: '🦄', text: 'Comparte tu sueño más loco' },
  { id: 31, emoji: '🍹', text: 'Pide al bartender una recomendación' },
  { id: 32, emoji: '👑', text: 'Corona a alguien "rey/reina de la noche"' },
  { id: 33, emoji: '🎉', text: 'Organiza una mini celebración' },
  { id: 34, emoji: '🧩', text: 'Encuentra 3 cosas en común con alguien' },
  { id: 35, emoji: '🌙', text: 'Comparte tu momento favorito del día' },
  { id: 36, emoji: '⚡', text: 'Haz algo espontáneo' },
  { id: 37, emoji: '🎨', text: 'Dibuja algo en una servilleta' },
  { id: 38, emoji: '🗣️', text: 'Habla en acento por 2 minutos' },
  { id: 39, emoji: '🤗', text: 'Dale un abrazo a 3 personas' },
  { id: 40, emoji: '🎁', text: 'Regala un cumplido creativo' },
  { id: 41, emoji: '🌟', text: 'Haz sentir especial a alguien' },
  { id: 42, emoji: '📱', text: 'Intercambia contacto con alguien nuevo' },
  { id: 43, emoji: '🎊', text: 'Celebra el logro de alguien' },
  { id: 44, emoji: '🔮', text: 'Predice algo sobre la noche' },
  { id: 45, emoji: '💫', text: 'Comparte tu mejor consejo de vida' },
  { id: 46, emoji: '🍾', text: 'Propón un brindis por algo inusual' },
  { id: 47, emoji: '🎯', text: 'Reta a alguien a hacer algo divertido' },
  { id: 48, emoji: '🌺', text: 'Halaga el outfit de 3 personas' },
  { id: 49, emoji: '🎼', text: 'Tararea una canción y que alguien la adivine' },
  { id: 50, emoji: '🚀', text: 'Comparte tu idea más innovadora' },
]
